...
public class Othello {
    ...
    public enum Peca { BRANCO, PRETO }
    public enum Casa { VAZIA, BRANCO, PRETO }

    public Casa[][] tabuleiro;
    private Peca turno;
    final private Peca minhaPeca;

    Othello(Peca minhaPeca) {
        turno = Peca.PRETO; // Preto sempre começa
        this.minhaPeca = minhaPeca;
        tabuleiro = new Casa[][]{
                {Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA},
                {Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA},
                {Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA},
                {Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.BRANCO, Casa.PRETO, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA},
                {Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.PRETO, Casa.BRANCO, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA},
                {Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA},
                {Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA},
                {Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA, Casa.VAZIA}
        };
    ...
    public void passarTurno() throws ExcecaoNaoPodePassarTurno {
        ...
        turno = turno.equals(Peca.BRANCO)
                ? Peca.PRETO
                : Peca.BRANCO;
    }
    ...
    public void colocarPeca(int linha, int coluna) throws ExcecaoCasaPreenchida {
        ...
        tabuleiro[linha][coluna] = minhaPeca.equals(Peca.BRANCO)
                ? Casa.BRANCO
                : Casa.PRETO;
    }
    ...
    public void virarPeca(int linha, int coluna) throws ExcecaoCasaVazia {
        ...
        tabuleiro[linha][coluna] = tabuleiro[linha][coluna].equals(Casa.BRANCO)
                ? Casa.PRETO
                : Casa.BRANCO;
    }
